...
class MenuBuilder {
    static func build() -> NSMenu {
        ...
        editMenu.addItem(NSMenuItem(title: "Redo", action: #selector(NotepadWindowController.redo), keyEquivalent: "_"))
        ...
        editMenu.addItem(NSMenuItem(title: "Delete", action: #selector(NotepadWindowController.delete), keyEquivalent: ""))
        editMenu.addItem(NSMenuItem.separator())
    ...
    static func buildEditMenu() -> NSMenu {
        ...
        menu.addItem(NSMenuItem(title: "Redo", action: #selector(NotepadWindowController.redo), keyEquivalent: "_"))
        menu.addItem(NSMenuItem.separator())
        ...
        menu.addItem(NSMenuItem(title: "Delete", action: #selector(NotepadWindowController.delete), keyEquivalent: ""))
        menu.addItem(NSMenuItem.separator())
